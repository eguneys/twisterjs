            ...
            <div class='lg:col-span-3 lg:sticky lg:top-24'>
                ...
                <div class='mb-8 space-y-4'>
                    ...
                    <div class='group'>
                      ...
                      <div class='relative group/code cursor-pointer bg-black/90 border border-gray-200 rounded-xs p-3 font-mono text-[11px] text-gray-600 hover:border-[#5f6fff]/30 transition-all'
