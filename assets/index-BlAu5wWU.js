...
`,demo:Mt};var Pt,Ft=()=>{Pt=0},It=e=>{Pt+=e/1e3},Lt=()=>{Rt.beginFrame(),Rt.strokeRect(1024/2,1024/2,1024,1024,1,Q.white),Rt.fillRect(1024/2,1024/2,1023,1023,Q.darkblue);let e=G(500,500),t=G(900,900),n=Math.sin(Pt)*Math.PI*2;t=Ye(t,n),Rt.strokeLine(e.x,e.y,t.x,t.y,1,Q.pink),Rt.endFrame()},Rt,zt=e=>{Rt=e};async function Bt(e){let t=mt(1024,1024,e,Lt);zt(t.batch),Ft();let n=ht(It,Lt);return{canvas:t.canvas,cleanup:()=>{t.cleanup(),n()}}}const Vt={id:`Welcome`,title:`Import as esnext module`,description:`Hey fellow indie, TwisterJS is only available as an esnext module.`,code:`
import { TwisterJS } from 'twisterjs'

console.log(TwisterJS) // logs TwisterJS
`,demo:Bt};var Ht,Ut,Wt=()=>{Ht=new et,Ut=new tt().set_line(`1000 jump 200 land 80`)},Gt=e=>{Ut.update(e),Ut.action===`jump`&&Ht.springTo(1e3),Ut.action===`land`&&Ht.springTo(900),Ut.action===`end`&&(Ht.springTo(0),Ut.set_line(`1000 jump 200 land 80`)),Ht.update(e/1e3)},Kt=()=>{qt.beginFrame(),qt.fillRect(Ht.value,0,100,100,gt.blue),qt.endFrame()},qt,Jt=e=>{qt=e};async function Yt(e){let t=mt(1024,1024,e,Kt);Jt(t.batch),Wt();let n=ht(Gt,Kt);return{canvas:t.canvas,cleanup:()=>{t.cleanup(),n()}}}const Xt={id:`Delay`,title:`Delay`,description:`Delay`,code:`
...
`,demo:Yt};var Zt,Qt,$t,en,tn,nn=()=>{en=new et,$t=new et,Zt=it(G(512,512),{radius:1,mass:1,maxSpeed:1e3,maxForce:2500,turnRate:Math.PI*2}),Qt=[new at(3,1,()=>G(en.value,500)),new ut(1,.25)],tn=new tt().set_line(`3000 right`)},rn=e=>{ct(Zt,Qt,[],e/1e3),$t.springTo(Zt.rotation+Math.PI*.5,{stiffness:1e3,damping:10}),$t.update(e/1e3),en.update(e/1e3),tn.update(e),tn.action===`left`?(en.springTo(0),tn.set_line(`3000 right`)):tn.action===`right`&&(en.springTo(1024),tn.set_line(`3000 left`))},an=()=>{on.beginFrame(),on.fillRect(512,512,1024,1024,gt.darkblue),on.strokeRect(512,512,1020,1020,4,Q.darkblue),on.fillRoundRect(Zt.position.x,Zt.position.y,80,140,16,gt.yellow,$t.value),on.fillRect(en.value,500,30,30,Q.black),on.endFrame()},on,sn=e=>{on=e};async function cn(e){let t=mt(1024,1024,e,an);sn(t.batch),nn();let n=ht(rn,an);return{canvas:t.canvas,cleanup:()=>{t.cleanup(),n()}}}const ln={id:`Steering`,title:`Steering Behaviors`,description:`Control a moving agent steer according to some Steering Behaviors`,code:`
...
`,demo:cn};var un=e=>{},dn=()=>{$.beginFrame(),$.fillRect(512,512,1024,1024,Q.red),$.fillRoundRect(500,100,300,80,10,Q.green),$.strokeRect(500,200,300,80,8,Q.orange),$.fillCircle(300,400,60,Q.blue),$.strokeCircle(800,400,60,8,Q.blue),$.strokeLine(100,600,900,600,2,Q.white),$.strokeLine(200,700,900,700,8,Q.white),$.strokeLine(300,800,900,800,16,Q.white),$.strokeLine(400,900,800,900,32,Q.white),$.endFrame()},$,fn=e=>{$=e};async function pn(e){let t=mt(1024,1024,e,dn);fn(t.batch);let n=ht(un,dn);return{canvas:t.canvas,cleanup:()=>{t.cleanup(),n()}}}const mn={id:`Shapes`,title:`Shapes`,description:`Shapes`,code:`
...
`,demo:pn};var hn=e=>{},gn=()=>{_n.beginFrame(),_n.fillRect(512,512,1024,1024,Q.blue),_n.fillRect(0,0,1024,1024,Q.red),_n.endFrame()},_n,vn=e=>{_n=e};async function yn(e){let t=mt(1024,1024,e,gn);vn(t.batch);let n=ht(hn,gn);return{canvas:t.canvas,cleanup:()=>{t.cleanup(),n()}}}const bn=[Vt,Nt,Xt,ln,mn,{id:`Webpage Integration`,title:`Add to a Webpage`,description:`A manager to add your game into your webpage and cleanup after it.`,code:`
/**
...
`}],$n=[{id:`Delay`,name:`new Delay()`,category:`Timing`,group:`Delay`,description:`A class for timing events`,example:`
let d = new Delay()
...
`}],nr=[...[{id:`vec2`,name:`vec2(x, y)`,category:`Math`,group:`Vector 2`,description:`A simple object for a 2D Vector`,example:`
let v = vec2(100, 100)
console.log(v.x, v.y) // logs 100 100
`},{id:`len2`,name:`len2(v: Vec2)`,category:`Math`,group:`Vector 2`,description:`Returns Vector's length squared`,example:`len(vec2(10, 10))`},{id:`length`,name:`length(v: Vec2)`,category:`Math`,group:`Vector 2`,description:`Returns Vector's length`,example:`length(vec_a)`},{id:`distance`,name:`distance(a: Vec2, b: Vec2)`,category:`Math`,group:`Vector 2`,description:`Returns the distance between 2 Vectors`,example:`distance(vec_a, vec_b)`},{id:`distance2`,name:`distance2(a: Vec2, b: Vec2)`,category:`Math`,group:`Vector 2`,description:`Returns the distance squared between 2 Vectors`,example:`distance2(vec_a, vec_b)`},{id:`normalize`,name:`normalize(v: Vec2)`,category:`Math`,group:`Vector 2`,description:`Returns the Vector normalized`,example:`normalize(vec2(10, 10))`},{id:`normalizeSafe`,name:`normalizeSafe(v: Vec2)`,category:`Math`,group:`Vector 2`,description:`Returns the Vector normalized but zero Vector when length is zero`,example:`normalizeSafe(vec_a)`},{id:`fromAngle`,name:`fromAngle(theta: number)`,category:`Math`,group:`Vector 2`,description:`Creates a vector directed towards angle theta (in radians)`,example:`fromAngle(Math.PI * 0.25)`},{id:`add`,name:`add(a: Vec2,b: Vec2)`,category:`Math`,group:`Vector 2`,description:`Adds two vectors`,example:`add(vec_a, vec_b)`},{id:`sub`,name:`sub(a: Vec2,b: Vec2)`,category:`Math`,group:`Vector 2`,description:`Subtracts two vectors`,example:`sub(vec_a, vec_b)`},{id:`mulScalar`,name:`mulScalar(v: Vec2,s: number)`,category:`Math`,group:`Vector 2`,description:`Multiplies vector by a scalar`,example:`mulScalar(vec_a, 10)`},{id:`dot`,name:`dot(a: Vec2,b: Vec2)`,category:`Math`,group:`Vector 2`,description:`Dot product of two vectors`,example:`dot(vec_a, vec_b)`},{id:`mul`,name:`mul(a: Vec2,b: Vec2)`,category:`Math`,group:`Vector 2`,description:`Multiplies two vectors`,example:`mul(vec_a, vec_b)`},{id:`perp`,name:`perp(a: Vec2)`,category:`Math`,group:`Vector 2`,description:`Returns the perpendicular Vector of the Vector`,example:`perp(vec_a)`},{id:`project`,name:`project(a: Vec2, target: Vec2)`,category:`Math`,group:`Vector 2`,description:`Projects Vector a onto Vector b`,example:`project(vec_a, vec_b)`},{id:`clampLength`,name:`clampLength(a: Vec2, max: number, min = 0)`,category:`Math`,group:`Vector 2`,description:`Clamps the Vector between max and min values`,example:`clampLength(vec(100, 50), 75, 10)`},{id:`rotateVec2`,name:`rotateVec2(v: Vec2, theta: number)`,category:`Math`,group:`Vector 2`,description:`Rotate the Vector by theta amount (theta in radians)`,example:`rotateVec2(vec2(100, 0), Math.PI * 0.5)`}],...er,...$n,...Qn,...tr],rr=[`Math`,`Timing`,`Animation`,`AI`,`Graphics`];var ir=H(`<div class="max-w-6xl mx-auto pt-20 pb-8 px-4"><div class="flex flex-col md:flex-row md:items-center justify-between mb-4 gap-4"><h2 class="text-xl font-bold tracking-tight dark:text-zinc-100">API Reference</h2><div class="flex gap-1 overflow-x-auto pb-1 scrollbar-hide"></div></div><div class=mb-6><input type=text placeholder="Filter API Surface..."class="w-full bg-zinc-50 dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-xs px-3 py-2 text-xs outline-none focus:border-brand-500 transition-all dark:text-zinc-100 dark:placeholder:text-zinc-600"></div><div class=space-y-8>`),ar=H(`<button>`),or=H(`<div class="text-center py-12 text-zinc-400 dark:text-zinc-700 text-xs italic">No functions found matching your criteria.`),sr=H(`<div class="animate-in fade-in duration-300"><h3 class="text-[10px] font-black uppercase tracking-[0.3em] text-brand-500 mb-4 border-b border-brand-500/10 pb-1"></h3><div class=space-y-4>`),cr=H(`<div class="text-center py-12 text-gray-400 text-xs italic">No functions found matching your criteria.`),lr=H(`<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 animate-in slide-in-from-top-1 duration-200">`),ur=H(`<div class="pl-2 border-l border-zinc-100 dark:border-zinc-800 transition-all"><button class="group/header w-full flex items-center justify-between py-1 px-2 rounded-md hover:bg-zinc-100/50 dark:hover:bg-zinc-800/50 transition-colors mb-2 text-left"><div class="flex items-center gap-2"><span></span><h4></h4></div><svg fill=none viewBox="0 0 24 24"stroke=currentColor><path stroke-linecap=round stroke-linejoin=round stroke-width=3 d="M19 9l-7 7-7-7">`),dr=H(`<div class="group p-3 bg-white dark:bg-zinc-900 border border-zinc-50 dark:border-zinc-800 rounded-xs hover:border-brand-500/30 transition-all hover:shadow-xs"><div class="flex justify-between items-center mb-1"><span class="text-[8px] font-black text-brand-500 dark:text-zinc-100 uppercase tracking-tighter"></span></div><div class="relative group/name mb-0.5"><h3 class="whitespace-pre-wrap text-xs font-bold mb-0.5 mono group-hover:text-brand-500 truncate dark:text-zinc-100"></h3><div class="whitespace-pre-wrap absolute bottom-full left-0 mb-2 invisible group-hover/name:visible opacity-0 group-hover/name:opacity-100 transition-all bg-[#1a1a1a] dark:bg-white dark:text-black text-white text-[10px] py-1 px-1 rounded-xs shadow-2xl z-60 pointer-events-none transform translate-y-1 group-hover/name:translate-y-0"></div></div><p class="text-zinc-400 dark:text-zinc-500 text-[10px] mb-2 leading-tight h-6 overflow-hidden"></p><div class="bg-zinc-50/50 dark:bg-zinc-950/50 p-1.5 rounded-xs border border-zinc-50/50 dark:border-zinc-800/50">`);const fr=()=>{let[e,t]=j(`All`),[n,r]=j(``),i=P(()=>{let t={};return nr.filter(t=>{let r=t.name.toLowerCase().includes(n().toLowerCase())||t.description.toLowerCase().includes(n().toLowerCase())||t.group.toLowerCase().includes(n().toLowerCase()),i=e()===`All`||t.category===e();return r&&i}).forEach(e=>{t[e.category]||(t[e.category]={});let n=t[e.category];n[e.group]||(n[e.group]=[]),n[e.group].push(e)}),t}),[a,o]=j(new Set,{equals:!1}),s=(e,t)=>{let n=a(),r=`${e}-${t}`;n.has(r)?n.delete(r):n.add(r),o(n)},c=(e,t)=>a().has(`${e}-${t}`),l=P(()=>Object.keys(i()));return(()=>{var a=ir(),o=a.firstChild,u=o.firstChild.nextSibling,d=o.nextSibling,f=d.firstChild,p=d.nextSibling;return W(u,B(V,{get each(){return[`All`,...rr]},children:n=>(()=>{var r=ar();return r.$$click=()=>t(n),W(r,n),M(()=>U(r,`px-3 py-1 rounded-xs text-[9px] font-bold uppercase tracking-wider transition-all border ${e()===n?`bg-zinc-900 text-white border-zinc-900 dark:bg-zinc-100 dark:text-zinc-900 dark:border-zinc-100`:`bg-white text-zinc-400 border-zinc-100 dark:bg-zinc-900 dark:text-zinc-500 dark:border-zinc-800`}`)),r})()})),f.addEventListener(`change`,e=>r(e.target.value)),W(p,B(V,{get each(){return l()},get fallback(){return or()},children:e=>(()=>{var t=sr(),n=t.firstChild,r=n.nextSibling;return W(n,e),W(r,B(V,{get each(){return Object.entries(i()[e])},get fallback(){return cr()},children:([t,n])=>(()=>{var r=ur(),i=r.firstChild,a=i.firstChild,o=a.firstChild,l=o.nextSibling,u=a.nextSibling;return i.$$click=()=>s(e,t),W(l,t),W(r,B(Oe,{get when(){return!c(e,t)},get children(){var e=lr();return W(e,B(V,{each:n,children:e=>(()=>{var t=dr(),n=t.firstChild,r=n.firstChild,i=n.nextSibling,a=i.firstChild,o=a.nextSibling,s=i.nextSibling,c=s.nextSibling;return W(r,()=>e.category),W(a,()=>e.name),W(o,()=>e.name),W(s,()=>e.description),W(c,B(Nn,{class:`text-[10px] mono text-zinc-500 dark:text-zinc-600 block truncate whitespace-pre-wrap`,get code(){return e.example.trim()}})),t})()})),e}}),null),M(n=>{var r=`w-1.5 h-1.5 rounded-full transition-colors ${c(e,t)?`bg-zinc-300 dark:bg-zinc-700`:`bg-brand-500`}`,i=`text-[11px] font-bold transition-colors ${c(e,t)?`text-zinc-400 dark:text-zinc-600`:`text-zinc-600 dark:text-zinc-300`}`,a=`w-3 h-3 text-zinc-300 dark:text-zinc-700 group-hover/header:text-brand-500 transition-transform duration-200 ${c(e,t)?`-rotate-90`:`rotate-0`}`;return r!==n.e&&U(o,n.e=r),i!==n.t&&U(l,n.t=i),a!==n.a&&Ne(u,`class`,n.a=a),n},{e:void 0,t:void 0,a:void 0}),r})()})),t})()})),M(()=>f.value=n()),a})()};Me([`click`]);var pr=H(`<div class="text-center md:text-left"><span class="block text-[8px] font-black text-brand-500 uppercase tracking[0.2em] mb-1"></span><span class="block text-xl font-bold text-zinc-900 dark:text-zinc-100 tracking-tighter">`),mr=[{label:`Language`,val:`Typescript / esnext`},{label:`Payload`,val:`Tiny Modular`},{label:`Design`,val:`Indie / AI`},{label:`Animation`,val:`Spring`},{label:`Timing`,val:`Delay`},{label:`AI`,val:`Steering Behaviors`},{label:`Math`,val:`Vec2 / Rect`},{label:`Rendering`,val:`Shapes with Batched WebGL`}];const hr=()=>B(V,{each:mr,children:e=>(()=>{var t=pr(),n=t.firstChild,r=n.nextSibling;return W(n,()=>e.label),W(r,()=>e.val),t})()});var gr=H(`<svg xmlns=http://www.w3.org/2000/svg class="w-4 h-4"fill=none viewBox="0 0 24 24"stroke=currentColor><path stroke-linecap=round stroke-linejoin=round stroke-width=2 d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m12.728 0l-.707-.707M6.343 6.343l-.707-.707M12 8a4 4 0 100 8 4 4 0 000-8z">`),_r=H(`<nav class="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md border-b border-zinc-100 dark:border-zinc-800 px-6 py-4 flex justify-between items-center transition-colors"><div class="text-2xl font-bold tracking-tighter cursor-pointer flex items-center gap-2 text-zinc-900 dark:text-white"><div class="w-4 h-4 bg-brand-500 rounded-[1px]"></div>TwisterJS</div><div class="flex items-center gap-8"><div class="flex gap-8 text-sm font-medium uppercase tracking-widest"></div><button class="p-2 roundex-xs hover:bg-zinc-200 dark:hover:bg-zinc-900 transition-colors text-zinc-400 dark:text-zinc-500 hover:text-brand"aria-label="Toggle theme">`),vr=H(`<button>`),yr=H(`<svg xmlns=http://www.w3.org/2000/svg class="w-4 h-4"fill=none viewBox="0 0 24 24"stroke=currentColor><path stroke-linecap=round stroke-linejoin=round stroke-width=2 d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z">`);const br=e=>{let t=[{id:`landing`,label:`Start`},{id:`cheatsheet`,label:`Docs`}];return(()=>{var n=_r(),r=n.firstChild,i=r.nextSibling.firstChild,a=i.nextSibling;return r.$$click=()=>e.onNavigate(`landing`),W(i,B(V,{each:t,children:t=>(()=>{var n=vr();return n.$$click=()=>e.onNavigate(t.id),W(n,()=>t.label),M(()=>U(n,`transition-colors hover:text-[#5f6fff]' ${e.currentSection===t.id?`text-brand-500`:`text-zinc-400 dark:text-zinc-500`}`)),n})()})),Pe(a,`click`,e.onToggleTheme,!0),W(a,B(Oe,{get when(){return e.isDark},get fallback(){return yr()},get children(){return gr()}})),n})()};Me([`click`]);var xr=H(`<div class="max-w-6xl mx-auto py-20 px-4"><div class="flex items-center gap-4 mb-10"><div class="h-px flex-1 bg-zinc-100 dark:bg-zinc-800"></div><div class=text-center><h2 class="text-xl font-bold tracking-tight dark:text-zinc-100">Community Showreel</h2><p class="text-[10px] text-zinc-400 dark:text-zinc-600 uppercase tracking-[0.2em] mt-1">Real projects built with TwisterJS</p></div><div class="h-px flex-1 bg-zinc-100 dark:bg-zinc-800"></div></div><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">`),Sr=H(`<a target=_blank rel="noopener noreferrer"class="group relative bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 p-6 roundex-xs transition-all hover:border-brand/40 hover:shadow-xs hover:-translate-y-1"><div class="flex justify-between items-start mb-4"><span class="text-[9px] font-mono text-zinc-500 dark:text-zinc-700"></span><div class="flex gap-1"></div></div><h3 class="text-lg font-bold text-zinc-900 dark:text-zinc-100 group-hover:text-brand-500 transition-colors"></h3><p class="text-[10px] text-zinc-400 dark:text-zinc-500 uppercase tracking-widest mt-1">by </p><div class="mt-6 flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-brand-500 opacity-0 group-hover:opacity-100 transition-all transform translate-x-2 group-hover:translate-x-0">See Game<svg xmlns=http://www.w3.org/2000/svg class="w-3 h-3"fill=none viewBox="0 0 24 24"stroke=currentColor><path stroke-linecap=round stroke-linejoin=round stroke-width=3 d="M14 5l7 7m0 0l-7 7m7-7H3">`),Cr=H(`<span class="text-[8px] px-1.5 py-0.5 bg-zinc-50 dark:bg-zinc-950 text-zinc-400 dark:text-zinc-500 rounded-xs border border-zinc-200 dark:bordre-zinc-800 font-bold uppercase tracking-wider">`);const wr=[{author:`twitch.tv/gsoutz`,title:`Mor Chess 3`,tags:[`puzzle`,`chess`,`minimalist`,`daily`],year:2026,url:`https://morchess.com/`}],Tr=()=>(()=>{var e=xr(),t=e.firstChild.nextSibling;return W(t,B(V,{each:wr,children:e=>(()=>{var t=Sr(),n=t.firstChild,r=n.firstChild,i=r.nextSibling,a=n.nextSibling,o=a.nextSibling;return o.firstChild,W(r,()=>e.year),W(i,B(V,{get each(){return e.tags},children:e=>(()=>{var t=Cr();return W(t,e),t})()})),W(a,()=>e.title),W(o,()=>e.author,null),M(()=>Ne(t,`href`,e.url)),t})()})),e})();var Er=H(`<section class="bg-white dark:bg-zinc-900 border-t border-zinc-100 dark:border-zinc-800 py-12 transition-colors"><div class="max-w-6xl mx-auto px-4"><div class="grid grid-cols-2 md:grid-cols-4 gap-6">`),Dr=H(`<section class=transition-colors>`),Or=H(`<section class="bg-zinc-50/50 dark:bg-zinc-950/50 border-t border-zinc-100 dark:border-zinc-800 transition-colors">`),kr=H(`<div><main class="transition-all duration-300"></main><footer class="py-10 border-t border-zinc-50 dark:border-zinc-900 text-center bg-white dark:bg-zinc-950 transition-colors"><p class="text-[9px] font-bold tracking-[0.3em] text-zinc-300 dark:text-zinc-700 uppercase">TwisterJS &bull; Tailored for the Indie &bull; 2026`);function Ar(){let[e,t]=j(`landing`),n=e=>{t(e)},[r,i]=Kn(j(window.matchMedia(`(prefers-color-scheme: dark)`).matches),{name:`.twisterjs.theme.is-dark`});return N(()=>{r()?document.documentElement.setAttribute(`data-theme`,`dark`):document.documentElement.removeAttribute(`data-theme`)}),(()=>{var t=kr(),a=t.firstChild;return W(t,B(br,{get currentSection(){return e()},onNavigate:n,get isDark(){return r()},onToggleTheme:()=>i(!r())}),a),W(a,B(Oe,{get when(){return e()===`landing`},get children(){return[B(Xn,{onExplore:()=>n(`cheatsheet`)}),(()=>{var e=Er(),t=e.firstChild.firstChild;return W(t,B(hr,{})),e})(),(()=>{var e=Dr();return W(e,B(Tr,{})),e})(),(()=>{var e=Or();return W(e,B(fr,{})),e})()]}}),null),W(a,B(Oe,{get when(){return e()===`cheatsheet`},get children(){return B(fr,{})}}),null),M(()=>U(t,`min-h-screen transition-colors duration-300 ${r()?`dark`:``} `)),t})()}je(()=>B(Ar,{}),document.getElementById(`root`));