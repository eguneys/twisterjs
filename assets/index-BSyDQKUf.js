...
`}],et=[{id:`Delay`,name:`new Delay()`,category:`Timing`,group:`Delay`,description:`A class for timing events`,example:`
let d = new Delay()
...
`}],rt=[...[{id:`vec2`,name:`vec2(x, y)`,category:`Math`,group:`Vector 2`,description:`A simple object for a 2D Vector`,example:`
let v = vec2(100, 100)
console.log(v.x, v.y) // logs 100 100
`},{id:`len2`,name:`len2(v: Vec2)`,category:`Math`,group:`Vector 2`,description:`Returns Vector's length squared`,example:`len(vec2(10, 10))`},{id:`length`,name:`length(v: Vec2)`,category:`Math`,group:`Vector 2`,description:`Returns Vector's length`,example:`length(vec_a)`},{id:`distance`,name:`distance(a: Vec2, b: Vec2)`,category:`Math`,group:`Vector 2`,description:`Returns the distance between 2 Vectors`,example:`distance(vec_a, vec_b)`},{id:`distance2`,name:`distance2(a: Vec2, b: Vec2)`,category:`Math`,group:`Vector 2`,description:`Returns the distance squared between 2 Vectors`,example:`distance2(vec_a, vec_b)`},{id:`normalize`,name:`normalize(v: Vec2)`,category:`Math`,group:`Vector 2`,description:`Returns the Vector normalized`,example:`normalize(vec2(10, 10))`},{id:`normalizeSafe`,name:`normalizeSafe(v: Vec2)`,category:`Math`,group:`Vector 2`,description:`Returns the Vector normalized but zero Vector when length is zero`,example:`normalizeSafe(vec_a)`},{id:`fromAngle`,name:`fromAngle(theta: number)`,category:`Math`,group:`Vector 2`,description:`Creates a vector directed towards angle theta (in radians)`,example:`fromAngle(Math.PI * 0.25)`},{id:`add`,name:`add(a: Vec2,b: Vec2)`,category:`Math`,group:`Vector 2`,description:`Adds two vectors`,example:`add(vec_a, vec_b)`},{id:`sub`,name:`sub(a: Vec2,b: Vec2)`,category:`Math`,group:`Vector 2`,description:`Subtracts two vectors`,example:`sub(vec_a, vec_b)`},{id:`mulScalar`,name:`mulScalar(v: Vec2,s: number)`,category:`Math`,group:`Vector 2`,description:`Multiplies vector by a scalar`,example:`mulScalar(vec_a, 10)`},{id:`dot`,name:`dot(a: Vec2,b: Vec2)`,category:`Math`,group:`Vector 2`,description:`Dot product of two vectors`,example:`dot(vec_a, vec_b)`},{id:`mul`,name:`mul(a: Vec2,b: Vec2)`,category:`Math`,group:`Vector 2`,description:`Multiplies two vectors`,example:`mul(vec_a, vec_b)`},{id:`perp`,name:`perp(a: Vec2)`,category:`Math`,group:`Vector 2`,description:`Returns the perpendicular Vector of the Vector`,example:`perp(vec_a)`},{id:`project`,name:`project(a: Vec2, target: Vec2)`,category:`Math`,group:`Vector 2`,description:`Projects Vector a onto Vector b`,example:`project(vec_a, vec_b)`},{id:`clampLength`,name:`clampLength(a: Vec2, max: number, min = 0)`,category:`Math`,group:`Vector 2`,description:`Clamps the Vector between max and min values`,example:`clampLength(vec(100, 50), 75, 10)`},{id:`rotateVec2`,name:`rotateVec2(v: Vec2, theta: number)`,category:`Math`,group:`Vector 2`,description:`Rotate the Vector by theta amount (theta in radians)`,example:`rotateVec2(vec2(100, 0), Math.PI * 0.5)`}],...tt,...et,...$e,...nt],it=[`Math`,`Timing`,`Animation`,`AI`,`Graphics`];var at=L(`<div class="max-w-6xl mx-auto pt-20 pb-8 px-4"><div class="flex flex-col md:flex-row md:items-center justify-between mb-4 gap-4"><h2 class="text-xl font-bold tracking-tight">API Reference</h2><div class="flex gap-1 overflow-x-auto pb-1 scrollbar-hide"></div></div><div class=mb-6><input type=text placeholder="Filter API Surface..."class="w-full bg-gray-50 border border-gray-100 rounded-xs px-3 py-2 text-xs outline-none focus:border-[#5f6fff] transition-all"></div><div class=space-y-8>`),ot=L(`<button>`),st=L(`<div class="text-center py-12 text-gray-400 text-xs italic">No functions found matching your criteria.`),ct=L(`<div class="animate-in fade-in duration-300"><h3 class="text-[10px] font-black uppercase tracking-[0.3em] text-[#5f6fff] mb-4 border-b border-[#5f6fff]/10 pb-1"></h3><div class=space-y-6>`),lt=L(`<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">`),ut=L(`<div class="pl-2 border-l border-gray-100 transition-all"><button class="group/header w-full flex items-center justify-between py-1 px-2 rounded-md hover:bg-gray-100/50 transition-colors mb-2 text-left"><div class="flex items-center gap-2"><span></span><h4>`),dt=L(`<div class="group p-3 bg-white border border-gray-100 rounded-xs hover:border-[#5f6fff] transition-all"><div class="flex justify-between items-center mb-1"><span class="text-[8px] font-black text-[#5f6fff] uppercase tracking-tighter"></span></div><div class="relative group/name mb-0.5"><h3 class="text-xs font-bold mb-0.5 mono group-hover:text-[#5f6fff] truncate"></h3><div class="absolute bottom-full left-0 mb-2 invisible group-hover/name:visible opacity-0 group-hover/name:opacity-100 transition-all bg-[#1a1a1a] text-white text-[10px] py-1 px-2 rounded-xs shadow-2xl whitespace-nowrap z-60 pointer-events-none transform translate-y-1 group-hover/name:translate-y-0"><div class="absolute top-full left-2 -mt-1 border-4 border-transparent border-t-[#1a1a1a]"></div></div></div><p class="text-gray-400 text-[10px] mb-2 leading-tight h-6 overflow-hidden line-clamp-2"></p><div class="bg-gray-50 p-2 rounded-xs border border-gray-50/50"><code class="text-[10px] mono text-gray-600 block truncate whitespace-pre-wrap">`);const ft=()=>{let[e,t]=x(`All`),[n,r]=x(``),i=C(()=>{let t={};return rt.filter(t=>{let r=t.name.toLowerCase().includes(n().toLowerCase())||t.description.toLowerCase().includes(n().toLowerCase())||t.group.toLowerCase().includes(n().toLowerCase()),i=e()===`All`||t.category===e();return r&&i}).forEach(e=>{t[e.category]||(t[e.category]={});let n=t[e.category];n[e.group]||(n[e.group]=[]),n[e.group].push(e)}),t}),[a,o]=x(new Set,{equals:!1}),s=(e,t)=>{let n=a(),r=`${e}-${t}`;n.has(r)?n.delete(r):n.add(r),o(n)},c=(e,t)=>a().has(`${e}-${t}`),l=C(()=>Object.keys(i()));return(()=>{var a=at(),o=a.firstChild,u=o.firstChild.nextSibling,d=o.nextSibling,f=d.firstChild,p=d.nextSibling;return B(u,P(F,{get each(){return[`All`,...it]},children:n=>(()=>{var r=ot();return r.$$click=()=>t(n),B(r,n),S(()=>z(r,`px-3 py-1 rounded-xs text-[9px] font-bold uppercase tracking-wider transition-all border ${e()===n?`bg-[#1a1a1a] text-white border-black`:`bg-white text-gray-400 border-gray-100`}`)),r})()})),f.addEventListener(`change`,e=>r(e.target.value)),B(p,P(F,{get each(){return l()},get fallback(){return st()},children:e=>(()=>{var t=ct(),n=t.firstChild,r=n.nextSibling;return B(n,e),B(r,P(F,{get each(){return Object.entries(i()[e])},get fallback(){return st()},children:([t,n])=>(()=>{var r=ut(),i=r.firstChild,a=i.firstChild.firstChild,o=a.nextSibling;return i.$$click=()=>s(e,t),B(o,t),B(r,P(I,{get when(){return!c(e,t)},get children(){var e=lt();return B(e,P(F,{each:n,children:e=>(()=>{var t=dt(),n=t.firstChild,r=n.firstChild,i=n.nextSibling,a=i.firstChild,o=a.nextSibling,s=o.firstChild,c=i.nextSibling,l=c.nextSibling.firstChild;return B(r,()=>e.category),B(a,()=>e.name),B(o,()=>e.name,s),B(c,()=>e.description),B(l,()=>e.example.trim()),t})()})),e}}),null),S(n=>{var r=`w-1.5 h-1.5 rounded-full transition-colors ${c(e,t)?`bg-gray-300`:`bg-[#5f6fff]`}`,i=`text-[11px] font-bold transition-colors ${c(e,t)?`text-gray-400`:`text-gray-600`}`;return r!==n.e&&z(a,n.e=r),i!==n.t&&z(o,n.t=i),n},{e:void 0,t:void 0}),r})()})),t})()})),S(()=>f.value=n()),a})()};R([`click`]);var pt=L(`<div class="text-center md:text-left"><span class="block text-[8px] font-black text-[#5f6fff] uppercase tracking[0.2em] mb-1"></span><span class="block text-xl font-bold text-gray-900 tracking-tighter">`),mt=[{label:`Payload`,val:`Tiny Modular`},{label:`Design`,val:`Indie / AI`},{label:`Animation`,val:`Spring`},{label:`Timing`,val:`Delay`},{label:`AI`,val:`Steering Behaviors`},{label:`Math`,val:`Vec2 / Polygon`},{label:`Rendering`,val:`Batched WebGL`}];const ht=()=>P(F,{each:mt,children:e=>(()=>{var t=pt(),n=t.firstChild,r=n.nextSibling;return B(n,()=>e.label),B(r,()=>e.val),t})()});var gt=L(`<section class="bg-white border-t border-gray-100 py-12"><div class="max-w-6xl mx-auto px-4"><div class="grid grid-cols-2 md:grid-cols-4 gap-6">`),_t=L(`<section class="bg-gray-50/50 border-t border-gray-100">`),vt=L(`<div class="min-h-screen selection:bg-[#5f6fff] selection:text-white bg-[#fcfcfc]"><main class="transition-all duration-300"></main><footer class="py-10 border-t border-gray-50 text-center bg-white"><p class="text-[9px] font-bold tracking-[0.3em] text-gray-300 uppercase">TwisterJS &bull; Tailored for the Indie &bull; 2026`),yt=L(`<nav class="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 px-6 py-4 flex justify-between items-center"><div class="text-2xl font-bold tracking-tighter cursor-pointer flex items-center gap-2"><div class="w-4 h-4 bg-[#5f6fff] rounded-[1px]"></div>TwisterJS</div><div class="flex gap-8 text-sm font-medium uppercase tracking-widest">`),bt=L(`<button>`);function xt(){let[e,t]=x(`landing`),n=e=>{t(e)};return(()=>{var t=vt(),r=t.firstChild;return B(t,P(St,{get currentSection(){return e()},onNavigate:n}),r),B(r,P(I,{get when(){return e()===`landing`},get children(){return[P(Ze,{onExplore:()=>n(`cheatsheet`)}),(()=>{var e=gt(),t=e.firstChild.firstChild;return B(t,P(ht,{})),e})(),(()=>{var e=_t();return B(e,P(ft,{})),e})()]}}),null),B(r,P(I,{get when(){return e()===`cheatsheet`},get children(){return P(ft,{})}}),null),t})()}var St=e=>{let t=[{id:`landing`,label:`Start`},{id:`cheatsheet`,label:`Docs`}];return(()=>{var n=yt(),r=n.firstChild,i=r.nextSibling;return r.$$click=()=>e.onNavigate(`landing`),B(i,P(F,{each:t,children:t=>(()=>{var n=bt();return n.$$click=()=>e.onNavigate(t.id),B(n,()=>t.label),S(()=>z(n,`transition-colors hover:text-[#5f6fff]' ${e.currentSection===t.id?`text-[#5f6fff]`:`text-gray-400`}`)),n})()})),n})()};R([`click`]),we(()=>P(xt,{}),document.getElementById(`root`));